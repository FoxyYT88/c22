var path,boy,cash,diamonds,jwellery,sword,DED;
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg,DEDImg;
...
boy.scale=0.08;
DED = createSprite(width/2,height/2,20,20)
DED.addImage(DEDImg)
DED.scale = 0.8
